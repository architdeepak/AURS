...
class drone_init:
    ...
    def zigzagsearch(self): #tested #only runs inference once
        ...
        for i in range(num_passes):
            ...
            print("Sleeping due to inference A")
            time.sleep(0.5)
            print(f'running inference {i}')
    ...
    def fly_to_target(self, input_lat, input_lon):
        ...
        self.move_to_fast(input_lat, input_lon, self.height / 2)
